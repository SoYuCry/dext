...
class aster(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        response = self.request("fapi/v1/exchangeInfo", "public", "GET", params or {})
    ...
    def fetch_ticker(self, symbol: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        response = self.request("fapi/v1/ticker/24hr", "public", "GET", self.extend(request, params or {}))
    ...
    def fetch_order_book(
        ...
        if limit is not None:
            request["limit"] = limit
        response = self.request("fapi/v1/depth", "public", "GET", self.extend(request, params or {}))
    ...
    def fetch_trades(
        ...
        if limit is not None:
            request["limit"] = limit
        response = self.request("fapi/v1/trades", "public", "GET", self.extend(request, params or {}))
    ...
    def fetch_ohlcv(
        ...
        response = self.request("fapi/v1/klines", "public", "GET", self.extend(request, params or {}))
    ...
    def fetch_balance(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        response = self.request("fapi/v2/balance", "private", "GET", params or {})
    ...
    def fetch_positions(self, symbols: Optional[List[str]] = None, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        response = self.request("fapi/v2/positionRisk", "private", "GET", params or {})
        results = []
    ...
    def create_order(
        ...
        response = self.request("fapi/v1/order", "private", "POST", self.extend(request, params))
    ...
    def cancel_order(
        ...
        if client_order_id is not None:
            ...
            params = self.omit(params, "clientOrderId")
        response = self.request("fapi/v1/order", "private", "DELETE", self.extend(request, params))
        return self.parse_order(response, market)
    ...
    def fetch_order(self, id: str, symbol: Optional[str] = None, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        response = self.request("fapi/v1/order", "private", "GET", self.extend(request, params))
        return self.parse_order(response, market)
    ...
    def fetch_open_orders(
        ...
        if symbol is not None:
            market = self.market(symbol)
            request["symbol"] = market["id"]
        response = self.request("fapi/v1/openOrders", "private", "GET", self.extend(request, params))
