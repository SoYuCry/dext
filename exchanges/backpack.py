...
from .endpoints.backpack import BackpackEndpoints
from .base.types import Any, Balances, Bool, Currencies, Currency, DepositAddress, Int, Market, MarketType, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, FundingRate, Trade, Transaction
...
from .base.errors import OperationRejected
from .base.errors import InsufficientFunds
from .base.errors import InvalidOrder
from .base.errors import OperationFailed
...
class backpack(Exchange):
    ...
    def describe(self) -> Any:
        return self.deep_extend(super(backpack, self).describe(), {
            ...
            'urls': {
                ...
                'referral': 'https://backpack.exchange/',
            },
            'api': {
                'public': {
                    'get': {
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response = self._request(self.endpoints.publicGetApiV1Assets, params)
        #
        #     [
        #         {
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        response = self._request(self.endpoints.publicGetApiV1Markets, params)
    ...
    def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a dictionary of standardized ticker structures
        """
        self.load_markets()
        request: dict = {}
        response = self._request(self.endpoints.publicGetApiV1Tickers, self.extend(request, params))
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a standardized ticker structure
        """
        self.load_markets()
        ...
        response = self._request(self.endpoints.publicGetApiV1Ticker, self.extend(request, params))
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        :returns dict: A dictionary of standardized order book structures indexed by market symbols
        """
        self.load_markets()
        market = self.market(symbol)
        request: dict = {
        ...
        response = self._request(self.endpoints.publicGetApiV1Depth, self.extend(request, params))
        #
        #     {
        #         "asks": [
        #             ["118318.3","0.00633"],
    ...
    def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        response = self._request(self.endpoints.publicGetApiV1Klines, self.extend(request, params))
    ...
    def fetch_funding_rate(self, symbol: str, params={}) -> FundingRate:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a standardized funding rate structure
        """
        self.load_markets()
        market = self.market(symbol)
        if market['spot']:
        ...
        response = self._request(self.endpoints.publicGetApiV1MarkPrices, self.extend(request, params))
    ...
    def fetch_open_interest(self, symbol: str, params={}):
        ...
        :returns dict: a standardized open interest structure
        """
        self.load_markets()
        market = self.market(symbol)
        if market['spot']:
        ...
        response = self._request(self.endpoints.publicGetApiV1OpenInterest, self.extend(request, params))
    ...
    def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of standardized funding rate structures
        """
        if symbol is None:
        ...
        response = self._request(self.endpoints.publicGetApiV1FundingRates, self.extend(request, params))
        #
        #     [
        #         {
        #             "fundingRate": "0.0001",
    ...
    def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        :returns Trade[]: a list of standardized trade structures
        """
        self.load_markets()
        market = self.market(symbol)
        request: dict = {
        ...
        if offset is not None:
            response = self._request(self.endpoints.publicGetApiV1TradesHistory, self.extend(request, params))
        else:
            response = self._request(self.endpoints.publicGetApiV1Trades, self.extend(request, params))
    ...
    def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = self._request(self.endpoints.privateGetWapiV1HistoryFills, self.extend(request, params))
        return self.parse_trades(response, market, since, limit)
    ...
    def fetch_status(self, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a standardized status structure
        """
        response = self._request(self.endpoints.publicGetApiV1Status, params)
        #
        #     {
        #         "message":null,
        #         "status":"Ok"
    ...
    def fetch_time(self, params={}) -> Int:
        ...
        """
        response = self._request(self.endpoints.publicGetApiV1Time, params)
        #
        #     1753131712992
        #
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a standardized balance structure
        """
        self.load_markets()
        response = self._request(self.endpoints.privateGetApiV1Capital, params)
    ...
    def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        response = self._request(self.endpoints.privateGetWapiV1CapitalDeposits, self.extend(request, params))
    ...
    def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        if until is not None:
            request['to'] = until
        response = self._request(self.endpoints.privateGetWapiV1CapitalWithdrawals, self.extend(request, params))
        return self.parse_transactions(response, currency, since, limit)
    ...
    def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params={}) -> Transaction:
        ...
        :returns dict: a standardized transaction structure
        """
        self.load_markets()
        currency = self.currency(code)
        request: dict = {
        ...
        response = self._request(self.endpoints.privatePostWapiV1CapitalWithdrawals, self.extend(request, query))
    ...
    def fetch_deposit_address(self, code: str, params={}) -> DepositAddress:
        ...
        :returns dict: a standardized address structure
        """
        self.load_markets()
        networkCode = None
        ...
        response = self._request(self.endpoints.privateGetWapiV1CapitalDepositAddress, self.extend(request, params))
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        response = self._request(self.endpoints.privatePostApiV1Order, orderRequest)
    ...
    def create_orders(self, orders: List[OrderRequest], params={}):
        ...
        response = self._request(self.endpoints.privatePostApiV1Orders, ordersRequests)
    ...
    def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns Order[]: a list of standardized order structures
        """
        self.load_markets()
        request: dict = {}
        market = None
        if symbol is not None:
            market = self.market(symbol)
            request['symbol'] = market['id']
        response = self._request(self.endpoints.privateGetApiV1Orders, self.extend(request, params))
    ...
    def fetch_open_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = self._request(self.endpoints.privateGetApiV1Order, self.extend(request, params))
    ...
    def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = self._request(self.endpoints.privateDeleteApiV1Order, self.extend(request, params))
        return self.parse_order(response)
    ...
    def cancel_all_orders(self, symbol: Str = None, params={}):
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of standardized order structures
        """
        self.load_markets()
        if symbol is None:
            raise ArgumentsRequired(self.id + ' cancelOrder() requires a symbol argument')
        ...
        response = self._request(self.endpoints.privateDeleteApiV1Orders, self.extend(request, params))
    ...
    def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self._request(self.endpoints.privateGetWapiV1HistoryOrders, self.extend(request, params))
        return self.parse_orders(response, market, since, limit)
    ...
    def fetch_positions(self, symbols: Strings = None, params={}) -> List[Position]:
        ...
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict[]: a list of standardized position structures
        """
        self.load_markets()
        response = self._request(self.endpoints.privateGetApiV1Position, params)
    ...
    def fetch_funding_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = self._request(self.endpoints.privateGetWapiV1HistoryFunding, self.extend(request, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        """
        Sign request for Backpack API

        This method is called by the base class's fetch2() method.
        For private endpoints, it adds Ed25519 signature headers.
        ...
        # 2. Sign the request if it's a private endpoint
        if api == 'private':
            ...
            # Get instruction from options (exchange-specific requirement)
            ...
            # Note: Could be refactored to use auth/backpack.py, but keeping current
            # implementation for now to maintain stability
        ...
        # 3. Build query string for GET requests
        if method == 'GET':
    ...
    def parse_error(self, response):
        """
        Parse Backpack-specific error responses
        ...
        Raises:
            ...
            InsufficientFunds: For insufficient funds errors
